...
Avanta WordPress Theme, Copyright 2019-2025 WordPress.org and contributors.
Avanta is distributed under the terms of the GNU GPL.
...
Avanta is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

Avanta bundles the following third-party resources:
...
Bespoke Icons Created For Avanta
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- avanta_SVG_Icons
- avanta_the_theme_svg()
- avanta_get_theme_svg()
- avanta_nav_menu_social_icons()
