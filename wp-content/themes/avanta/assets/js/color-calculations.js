 ...
 * @return {Object} - this
 */
function _avantaColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_avantaColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_avantaColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_avantaColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Returns a new instance of the _avantaColor object.
 *
 * @since Avanta 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function avantaColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _avantaColor( backgroundColor, accentHue );
